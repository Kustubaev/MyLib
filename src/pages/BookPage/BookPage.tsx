    ...
    <div >
      <div className={cls.BookDetailBlock}>
        <div className={cls.BookDetailBlock__left}>
          <img className={cls.BookDetailBlock__left__img} src="../src/img/ExampleOblojka1.webp" alt="" />
        </div>
          ...
          <>
            ...
            <div className={cls.BookDetailBlock__right}>
              ...
              <div className={cls.BookDetailBlock__right__info}>
                <div className={cls.BookDetailBlock__right__info__genre}>Жанр: жанр</div>
                <div className={cls.BookDetailBlock__right__info__author}>Автор: Иван Иванов</div>
              </div>

              <div className={cls.BookDetailBlock__right__about}>
                <div className={cls.BookDetailBlock__right__about__title}>О книге</div>
                <div className={cls.BookDetailBlock__right__about__text}>{book.content}</div>
              </div>
            </div>
          </>
        )}
